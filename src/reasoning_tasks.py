...
def test_all_tasks():
  ...
  print(" OK Train/test split works")
...
def visualize_all_tasks(test_results):
  ...
  tracking_path = IMAGES_DIR / "task_tracking_example.png"
  ...
  matching_path = IMAGES_DIR / "task_matching_example.png"
  plt.savefig(matching_path, dpi=150, bbox_inches='tight')
  print(f" Saved: {matching_path}")

  # bAbI QA
  X3, y3, meta3 = test_results['babi']
  fig3 = visualize_example(X3, y3, meta3, sample_idx=0, task_type='babi')
  babi_path = IMAGES_DIR / "task_babi_example.png"
  plt.savefig(babi_path, dpi=150, bbox_inches='tight')
  print(f" Saved: {babi_path}")
