...
def test_lstm():
  ...
  print(f"  OK Shape correct, no NaN/Inf")
  ...
  print(f"  OK Forget gate bias initialized to 1.0")
  ...
  print(f"  OK Other biases initialized to 0.0")
  ...
  print(f"  OK Recurrent weights are {'orthogonal' if is_orthogonal else 'approximately orthogonal'}")
  ...
  print(f"  OK State evolves correctly with different inputs")
  ...
  print(f"  OK Single step processing works correctly")
