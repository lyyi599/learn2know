...
**RelationalRNNCell**:
- LSTM cell parameters (4 gates x 2 weight matrices + biases)
...
- Random sequence processing: batch=2, seq_len=10, input_size=32 OK
- Shape verification at each step OK
- Memory evolution over time OK
- Comparison with LSTM baseline OK
- No NaN/Inf in forward passes OK
- State management correct OK
