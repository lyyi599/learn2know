...
def quick_test():
  ...
  print(f" OK Cross-entropy: {ce_loss_sparse:.4f}")
  ...
  print(f" OK Original norm: {norm:.4f}")
  print(f" OK Clipped norm: {clipped_norm:.4f}")
  ...
  print(f" OK Epoch 0: {lr0:.6f}")
  print(f" OK Epoch 10: {lr10:.6f}")
  ...
  print(f" OK Stopped at epoch {i}")
  print(f" OK Best loss: {early_stop.best_loss:.2f}")
  ...
  print(f" OK Accuracy: {acc:.4f}")
  print(f" OK Grad norm: {grad_norm:.4f}")
  ...
  # Summary
  print("\n" + "=" * 60)
  print("All Quick Tests Passed! OK")
  print("=" * 60)
  print("\nUtilities tested:")
  print(" OK cross_entropy_loss")
  print(" OK mse_loss")
  print(" OK accuracy")
  print(" OK clip_gradients")
  print(" OK learning_rate_schedule")
  print(" OK EarlyStopping")
  print(" OK train_step")
  print(" OK evaluate")
